...
run test_print_fires1 python src/print_fires.py --country Zimbabwe --fires_column 3 --file_name test/TestAgrofood.csv
...
run test_print_fires1 python src/print_fires.py --country Zimbabwe --fires_column 3 --file_name test/TestAgrofood.csv --operation mean
assert_in_stdout 190.1290322580645
assert_exit_code 0
