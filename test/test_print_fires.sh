...
run test_print_fires1 src/print_fires.py --country Zimbabwe --fires_column 3 --file_name TestAgrofood.csv
...
run test_print_fires1 python src/print_fires.py --country FAKECOUNTRY --fires_column 3 --file_name TestAgrofood.csv
assert_in_stdout 
assert_exit_code 0
