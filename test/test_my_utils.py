...
class TestMyUtils(unittest.TestCase):
    def test_get_column(self):
        ...
        self.assertIsInstance(my_utils.get_column(
            './Assignments/assignment-2-python-refresher-hessewithbroej/Agrofood_co2_emission.csv', 0,'Zimbabwe', result_column=1),list)
    ...
    def test_calc_mean_random(self):
        ...
        for i in range(1,1000):
            ...
            arr = [random.randint(0,1000000) for _ in range(random.randint(1,1000))]
    ...
    def test_calc_stdev_fixed(self):
        ...
        self.assertAlmostEqual(my_utils.calc_stdev([1.1,2.2,3.3])**2,2*(1.1**2)/3)
    ...
    def test_calc_stdev_random(self):
        ...
        for i in range(1,1000):
            # generate arbitrary list length up to 1000 elements
            arr = [random.randint(0,1000000) for _ in range(random.randint(2,1000))]
