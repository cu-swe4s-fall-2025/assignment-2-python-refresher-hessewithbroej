...
parser = argparse.ArgumentParser(
            description="Assignment3 Code: Prints user-selected data from a csv",
            prog='print_fires'
)
...
parser.add_argument('--country_column',
                    type=int,
                    help='Index of column of .csv file that contains the countries',
                    default=0)

parser.add_argument('--fires_column',
                    type=int,
                    help='Index of column of .csv file that contains the fire data',
                    default=3)
